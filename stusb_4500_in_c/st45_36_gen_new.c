...
uint8_t* _st45_gen_new_config( float __Iconfig1, 
    ...
    _st45newConfig . pdo1 . Vf = 5 ;
    _st45newConfig . pdo1 . Vu = 5 * 20 ;
    _st45newConfig . pdo2 . Vf = __Vconfig2 ;
    _st45newConfig . pdo2 . Vu = __Vconfig2 * 20 ;
    _st45newConfig . pdo3 . Vf = __Vconfig3 ;
    _st45newConfig . pdo3 . Vu = __Vconfig3 * 20 ;

    _st45newConfig . pdo1 . If = __Iconfig1 ;
    _st45newConfig . pdo1 . Iu = __Iconfig1 * 20 ;
    _st45newConfig . pdo2 . If = __Iconfig2 ;
    _st45newConfig . pdo2 . Iu = __Iconfig2 * 20 ;
    _st45newConfig . pdo3 . If = __Iconfig3 ;
    _st45newConfig . pdo3 . Iu = __Iconfig3 * 20 ;
