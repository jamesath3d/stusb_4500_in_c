...
ST45config* _st45_analyze_nvm( ST45config* ___st45config, uint8_t* ___nvmBuf ) {
    ...
    //PDO Number
    _st45analyze . pdoAmount = (_st45nvm[3][2]>>1) & 0x3UL ;
    ...
    __u01 = 0x00FFUL & _st45nvm[4][1] ;
    __u01 <<= 2 ;
    __u01 |= (0x0003UL & (_st45nvm[4][0]>>6)) ;
    ...
    __u01 = 0x0003UL & _st45nvm[4][3] ;
    __u01 <<= 8 ;
    __u01 |= 0x00FFUL & _st45nvm[4][2] ;
    ...
    if(0) printf("3:3,4,5,6 -> %02hhx, %02hhx, %02hhx, %02hhx \n", 
            _st45nvm[3][3], _st45nvm[3][4], _st45nvm[3][5], _st45nvm[3][6] );
    //_st45analyze . pdo[0] . lowerVpercent = 5 ;
    _st45analyze . pdo[0] . lowerVpercent =  (0x000FUL & _st45nvm[3][3]) ; // maybe
    _st45analyze . pdo[1] . lowerVpercent = ((0x00F0UL & _st45nvm[3][4]) >>4 ) ;
    _st45analyze . pdo[2] . lowerVpercent =  (0x000FUL & _st45nvm[3][6]) ;

    _st45analyze . pdo[0] . upperVpercent = ( (0x00F0UL & _st45nvm[3][3] ) >> 4 ) ;
    _st45analyze . pdo[1] . upperVpercent = ( (0x000FUL & _st45nvm[3][5] ) ) ;
    _st45analyze . pdo[2] . upperVpercent = ( (0x00F0UL & _st45nvm[3][6] ) >> 4 ) ;

    _st45analyze . flexCurrentU = ((0x000FUL & _st45nvm[4][4])<<6) | ((0x00FCUL & _st45nvm[4][3])>>2);
